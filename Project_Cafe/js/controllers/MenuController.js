(function() {
    ...
    MenuController.$inject = ['$scope', '$timeout', '$interval', 'ApiService', 'NotificationService', 'AuthService'];

    function MenuController($scope, $timeout, $interval, ApiService, NotificationService, AuthService) {
        var vm = this;
                ...
                .then(function(response) {
                    ...
                    vm.products = products.map(function(product) {
                        ...
                        return {
                            ...
                            image: product.hinhanh || product.HINHANH || null
                        };
                    });
