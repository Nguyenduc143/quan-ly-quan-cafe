(function() {
    ...
    TableController.$inject = ['$scope', '$location', '$timeout', 'ApiService', 'NotificationService'];

    function TableController($scope, $location, $timeout, ApiService, NotificationService) {
        var vm = this;
